...
case "$ARCH" in
    ...
    aarch64|arm64)
        #~~ Binaries for tests ~~~~~~~~~~~~~~~~~~~~~
        normal_dyn="./tools/binaries_sample_arm64/ls"
        normal_static="./tools/binaries_sample_arm64/simple_static"
        dynexec_test_bin="./tools/binaries_sample_arm64/dynexec_probe"
        big_dyn="./tools/binaries_sample/qemu-system-aarch64"
        big_static="./tools/binaries_sample/rclone"
        #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        ;;
