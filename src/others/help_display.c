...
static const char *const help_lines[] = {
    ...
    GRY WHI10 " --password" GREY17 "     password protection",
...
static const char *const help_algos_lines[] = {
    ...
    GRY GREY17 "  compression ratio.",
       GRY FBB3 "   comp.speed" GREY17 " ✪✪✪✪○   " FBB3 "decomp.speed" GREY17 " ✪✪✪✪✪   " FBB3 "avg.ratio" GREY17 " ✪✪○○○",
    ...
    GRY18 FBB3 "   comp.speed" GREY17 " ✪✪✪✪✪   " FBB3 "decomp.speed" GREY17 " ✪✪✪✪○   " FBB3 "avg.ratio" GREY17 " ✪○○○○",
