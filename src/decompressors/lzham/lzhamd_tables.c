// lzhamd_tables.c - LZX position tables for pure C LZHAM decompressor
// Generated from lzham_lzdecompbase.cpp (frozen values). C99.

#include "lzhamd_internal.h"

const uint32_t g_lzhamd_lzx_position_base[LZHAMD_C_LZX_MAX_POSITION_SLOTS] = {
...
const uint32_t g_lzhamd_lzx_position_extra_mask[LZHAMD_C_LZX_MAX_POSITION_SLOTS] = {
...
const uint8_t g_lzhamd_lzx_position_extra_bits[LZHAMD_C_LZX_MAX_POSITION_SLOTS] = {
