 ...
 */
static size_t HUF_DecompressAsmArgs_init(HUF_DecompressAsmArgs *args, void *dst,
                                         size_t dstSize, void const *src,
                                         size_t srcSize,
                                         const HUF_DTable *DTable) {
...
static size_t HUF_initRemainingDStream(BIT_DStream_t *bit,
                                       HUF_DecompressAsmArgs const *args,
...
size_t HUF_readDTableX1_wksp(HUF_DTable *DTable, const void *src,
  ...
  return HUF_readDTableX1_wksp_bmi2(DTable, src, srcSize, workSpace, wkspSize,
                                    /* bmi2 */ 0);
}
#endif
...
size_t HUF_readDTableX1_wksp_bmi2(HUF_DTable *DTable, const void *src,
  ...
  iSize = HUF_readStats_wksp(wksp->huffWeight, HUF_SYMBOLVALUE_MAX + 1,
                             ...
                             wksp->statsWksp, sizeof(wksp->statsWksp), bmi2);
...
static TARGET_ATTRIBUTE("bmi2") size_t
    HUF_decompress4X1_usingDTable_internal_bmi2(void *dst, size_t dstSize,
                                                void const *cSrc,
                                                size_t cSrcSize,
...
HUF_ASM_DECL void HUF_decompress4X1_usingDTable_internal_bmi2_asm_loop(
    HUF_DecompressAsmArgs *args);

static HUF_ASM_X86_64_BMI2_ATTRS size_t
HUF_decompress4X1_usingDTable_internal_bmi2_asm(void *dst, size_t dstSize,
                                                const void *cSrc,
                                                size_t cSrcSize,
                                                const HUF_DTable *DTable) {
  void const *dt = DTable + 1;
  ...
  {
    size_t const ret =
        HUF_DecompressAsmArgs_init(&args, dst, dstSize, cSrc, cSrcSize, DTable);
...
static size_t HUF_decompress4X1_usingDTable_internal(void *dst, size_t dstSize,
  ...
  if (bmi2) {
#if HUF_ENABLE_ASM_X86_64_BMI2
    return HUF_decompress4X1_usingDTable_internal_bmi2_asm(dst, dstSize, cSrc,
                                                           cSrcSize, DTable);
#else
    return HUF_decompress4X1_usingDTable_internal_bmi2(dst, dstSize, cSrc,
                                                       cSrcSize, DTable);
...
static size_t HUF_decompress4X1_DCtx_wksp_bmi2(HUF_DTable *dctx, void *dst,
  ...
  size_t const hSize = HUF_readDTableX1_wksp_bmi2(dctx, cSrc, cSrcSize,
...
size_t HUF_readDTableX2_wksp(HUF_DTable *DTable, const void *src,
                             size_t srcSize, void *workSpace, size_t wkspSize) {
  return HUF_readDTableX2_wksp_bmi2(DTable, src, srcSize, workSpace, wkspSize,
                                    /* bmi2 */ 0);
}

size_t HUF_readDTableX2_wksp_bmi2(HUF_DTable *DTable, const void *src,
                                  size_t srcSize, void *workSpace,
                                  size_t wkspSize, int bmi2) {
  ...
  iSize =
      HUF_readStats_wksp(wksp->weightList, HUF_SYMBOLVALUE_MAX + 1,
                         ...
                         wksp->calleeWksp, sizeof(wksp->calleeWksp), bmi2);
  if (HUF_isError(iSize))
    return iSize;
...
#if HUF_NEED_BMI2_FUNCTION
static TARGET_ATTRIBUTE("bmi2") size_t
    HUF_decompress4X2_usingDTable_internal_bmi2(void *dst, size_t dstSize,
                                                void const *cSrc,
                                                size_t cSrcSize,
                                                HUF_DTable const *DTable) {
...
HUF_ASM_DECL void HUF_decompress4X2_usingDTable_internal_bmi2_asm_loop(
    HUF_DecompressAsmArgs *args);

static HUF_ASM_X86_64_BMI2_ATTRS size_t
HUF_decompress4X2_usingDTable_internal_bmi2_asm(void *dst, size_t dstSize,
                                                const void *cSrc,
                                                size_t cSrcSize,
                                                const HUF_DTable *DTable) {
  void const *dt = DTable + 1;
...
static size_t HUF_decompress4X2_usingDTable_internal(void *dst, size_t dstSize,
  ...
  if (bmi2) {
#if HUF_ENABLE_ASM_X86_64_BMI2
    return HUF_decompress4X2_usingDTable_internal_bmi2_asm(dst, dstSize, cSrc,
                                                           cSrcSize, DTable);
#else
    return HUF_decompress4X2_usingDTable_internal_bmi2(dst, dstSize, cSrc,
                                                       cSrcSize, DTable);
