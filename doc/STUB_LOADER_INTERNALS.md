...
| **VMA scan** | `virtual_start < 0x10000` (PIE) | Marker search in memory |
...
```c
// Iterate VMAs via /proc/self/maps parsing
// Search the 6-byte marker (e.g., "zELFl4")
