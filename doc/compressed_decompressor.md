...
- A portable implementation across OS/arch (target is Linux x86_64).
...
- **Stage-0 implementation**:
  - Assembly entry: `src/stub/stage0_nrv2b_le32.S`
  - Minimal NRV decoder in C: `src/tools/ucl/minidec_nrv2b_le32.c` and `.h`
  - Offsets header: `build/stage0_nrv2b_le32_offsets.h`, binary blob: `build/stage0_nrv2b_le32.bin`
